      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          >
            ...
            <span>Tambah Kuliner Kudus</span>
          </button>
        </div>
      </div>
        ...
        <>
          ...
          <div className="bg-white rounded-3xl p-4 sm:p-5 border border-[#FFE8DD] shadow-soft mb-6 space-y-3">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Cari soto, sate kerbau, lentog, garang asem, kafe Kudus..."
                value={searchQuery}
          ...
          <div className="flex items-center justify-between mb-3 px-1 text-xs font-bold text-[#183153]/70">
            <span>
              Menampilkan {filteredList.length} dari {items.length} kuliner di Kudus
            </span>
